...
import com.portfolio.yt.Dto.dtoExperiencia;
import com.portfolio.yt.Entity.Experiencia;
import com.portfolio.yt.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexperiencia){
        ...
        /*Esta linea tiene que coinicidor con la lista*/
       Experiencia experiencia = new Experiencia(dtoexperiencia.getNombreE(), dtoexperiencia.getDescripcionE(), dtoexperiencia.getEstadoE());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexperiencia){
        ...
        if(StringUtils.isAllBlank(dtoexperiencia.getNombreE()))
        ...
        experiencia.setEstadoE(dtoexperiencia.getEstadoE());
